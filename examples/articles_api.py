...
class ArticlesApi:
    ...
    async def v2_articles_article_id_fork_put(
        self,
        article_id: Annotated[StrictStr, Field(description="The ID of the article")],
        fork_article_version_request: Optional[ForkArticleVersionRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def v2_articles_article_id_lang_code_get(
        ...
        is_for_display: Annotated[Optional[StrictBool], Field(description="Set this to true, if you are displaying the article to the end-user. If true, the content of snippets or variables appears in the article. Note: If the value is true, ensure that the article content is not passed for update article endpoints.")] = None,
        is_published: Annotated[Optional[StrictBool], Field(description="**true** : You will get the latest published version of the article. (If there are no published versions, then it will return the latest version)              **false** : To get the the latest version of the article")] = None,
        append_sas_token: Annotated[Optional[StrictBool], Field(description="Set this to false to exclude appending SAS token for images/files")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def v2_articles_article_id_lang_code_publish_post(
        ...
        article_id: Annotated[StrictStr, Field(description="The ID of the article")],
        lang_code: Annotated[StrictStr, Field(description="Language code of the article")],
        publish_article_request: Optional[PublishArticleRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def v2_articles_article_id_lang_code_put(
        ...
        article_id: Annotated[StrictStr, Field(description="The ID of the article")],
        lang_code: Annotated[StrictStr, Field(description="Language code of the article")],
        update_article_request: Optional[UpdateArticleRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def v2_articles_article_id_lang_code_settings_put(
        ...
        article_id: Annotated[StrictStr, Field(description="The ID of the article")],
        lang_code: Annotated[StrictStr, Field(description="Language code of the article")],
        update_article_settings_request: Optional[UpdateArticleSettingsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def v2_articles_article_id_lang_code_update_description_put(
        ...
        article_id: Annotated[StrictStr, Field(description="The ID of the article")],
        lang_code: Annotated[StrictStr, Field(description="Language code of the article")],
        description: Annotated[Optional[Annotated[str, Field(strict=True, max_length=250)]], Field(description="The description of the article")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def v2_articles_bulkcreate_post(
        self,
        create_article_request: Optional[List[CreateArticleRequest]] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def v2_articles_bulkpublish_lang_code_post(
        self,
        lang_code: Annotated[StrictStr, Field(description="Language code of the article")],
        bulk_publish_article: Optional[List[BulkPublishArticle]] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def v2_articles_bulkupdate_put(
        self,
        bulk_update_article: Optional[List[BulkUpdateArticle]] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def v2_articles_post(
        self,
        create_article_request: Optional[CreateArticleRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
